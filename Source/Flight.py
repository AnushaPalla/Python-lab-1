...
person1 = Person('raji',55,1234567890)
...
employee1 = Employee("Rajeshwari",22,1234567890,'14b81a12b6')
employee2 = Employee("Shravya",33,1234567890,'14b81a12c0')
...
passenger1 = Passenger("Cholleti",33,1234567890,67)
